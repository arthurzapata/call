...
$colname_mos_curso = "-1";
if (isset($_GET['id'])) {
  $colname_mos_curso = $_GET['id'];
} 
mysql_select_db($database_conexion, $conexion);
$query_mos_curso = "SELECT vis_id,  DATE_FORMAT(vis_fecha,'%e-%m-%Y') as vis_fecha,vis_lugar,vis_cli,vis_tipovisita,hora_ini,hora_fin,usu_id, DATE_FORMAT(fecha_reg,'%e-%m-%Y') as fecha_reg,motivo FROM call_visitas WHERE vis_id = ".$colname_mos_curso."";
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE call_visitas SET vis_fecha=%s,vis_lugar=%s, vis_cli=%s, vis_tipovisita=%s, hora_ini=%s,hora_fin=%s,  motivo=%s WHERE vis_id=%s",
                       GetSQLValueString($fechaconver, "date"),
                       GetSQLValueString($_POST['vis_lugar'], "text"),
                       GetSQLValueString($_POST['vis_cli'], "text"),
                       GetSQLValueString($_POST['vis_tipovisita'], "text"),
                       ...
                       GetSQLValueString($_POST['hora_fin'], "text"),
                       GetSQLValueString($_POST['motivo'], "text"),
                       GetSQLValueString($_POST['vis_id'], "int"));
  mysql_select_db($database_conexion, $conexion);
...
<div class="row">
                ...
                <div class="box box-primary">
                  ...
                  <h3 class="box-title"><i class="fa fa-briefcase"></i> Editar Visita</h3>
                  </div>
                  ...
                  <div class="box-body">
                    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                        ...
                        <div class="form-group">Fecha Visita:
                          ...
                          <input type="text" id="vis_fecha" name="vis_fecha" value="<?php echo htmlentities($row_mos_curso['vis_fecha'], ENT_COMPAT, 'UTF-8'); ?>" class="form-control" placeholder="dd-mm-yyyy" required>
                            </div>
                        </div>
                        <div class="form-group">Lugar:
                          <input type="text" name="vis_lugar" value="<?php echo htmlentities($row_mos_curso['vis_lugar'], ENT_COMPAT, 'UTF-8'); ?>"  class="form-control" maxlength="100">
                        </div>
                        <div class="form-group">Cliente:
                          <input type="text" name="vis_cli" value="<?php echo htmlentities($row_mos_curso['vis_cli'], ENT_COMPAT, 'UTF-8'); ?>"  class="form-control" maxlength="100">
                        </div>
                        <div class="form-group">Tipo Visita:
                          <input type="text" name="vis_tipovisita" value="<?php echo htmlentities($row_mos_curso['vis_tipovisita'], ENT_COMPAT, 'UTF-8'); ?>" class="form-control" maxlength="100">
                        </div>
                        <div class="form-group">Motivo:
                          <textarea name="motivo" class="form-control" value="<?php echo htmlentities($row_mos_curso['motivo'], ENT_COMPAT, 'UTF-8'); ?>" ></textarea>
                        </div>
                        <div class="row">
                          <div class="col-md-6">
                           <div class="form-group">Hora Ini:
                            <input type="text" name="hora_ini" value="<?php echo htmlentities($row_mos_curso['hora_ini'], ENT_COMPAT, 'UTF-8'); ?>" class="form-control">
                          </div></div>
                          <div class="col-md-6">
                          <div class="form-group">Hora Fin:
                            <input type="text" name="hora_fin" value="<?php echo htmlentities($row_mos_curso['hora_fin'], ENT_COMPAT, 'UTF-8'); ?>" class="form-control">
                          </div></div>
                        </div>
              ...
              <a href="visitas.php" style="margin-left:10px;">
                 <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-times"></i> Cancelar</button></a>
                      ...
                      <input type="hidden" name="vis_id" value="<?php echo $row_mos_curso['vis_id']; ?>">
                    </form>
                  </div>                 
                  <!-- body -->
    </div><!-- /.primary-->
