...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO call_estado (est_nombre,est_color) VALUES (%s,%s)",
                       GetSQLValueString(strtoupper($_POST['est_nombre']), "text"),
...
<div class="row">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-header"> <h3 class="box-title"> 
               	  <i class="fa fa-retweet"></i> Nuevo Estado</h3></div>
                   
                  <div class="box-body">
                    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                     
                        <div class="form-group">Estado:
                          <input type="text" name="est_nombre" value="" class="form-control" required>
                        </div>
                     	<div class="form-group">Color:
                          <select name="est_color" class="form-control">
                            ...
                            <option value="primary">maroon</option>
