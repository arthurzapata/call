...
mysql_select_db($database_conexion, $conexion);
$query_mos_curso = sprintf("SELECT * FROM producto WHERE pro_id = %s", GetSQLValueString($colname_mos_curso, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE producto SET pro_descripcion=%s WHERE pro_id=%s",
                       GetSQLValueString($_POST['pro_descripcion'], "text"),
...
<div class="row">
                ...
                <div class="box box-primary">
                  ...
                  <h3 class="box-title"><i class="fa fa-briefcase"></i> Editar Producto</h3>
                  </div>
                  ...
                  <div class="box-body">
                    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                        ...
                        <div class="form-group">Descripción :
                          <input type="text" id="pro_descripcion" name="pro_descripcion" value="<?php echo htmlentities($row_mos_curso['pro_descripcion'], ENT_COMPAT, 'UTF-8'); ?>" class="form-control" required>
                        </div>
              ...
              <a href="producto.php" style="margin-left:10px;">
                 <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-times"></i> Cancelar</button></a>
                      <input type="hidden" name="MM_update" value="form1">
                      <input type="hidden" name="pro_id" value="<?php echo $row_mos_curso['pro_id']; ?>">
                    </form>
                  </div>                 
                  <!-- body -->
    </div><!-- /.primary-->
