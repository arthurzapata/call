...
/*  $fecha_remitido = $_POST['vis_fecha'];cio
  $fechaconver = implode('-',array_reverse(explode('-', $fecha_remitido)));
 */
  $insertSQL = sprintf("INSERT INTO producto (pro_descripcion, pro_activo) VALUES ( %s, %s)",
...
<div class="row">
                ...
                <div class="box box-primary">
                  ...
                  <h3 class="box-title"><i class="fa fa-briefcase"></i> Nuevo Producto</h3>
                  </div>
                  ...
                  <div class="box-body">
                    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                        ...
                        <div class="form-group">Descripción :
                          <input type="text" id="pro_descripcion" name="pro_descripcion" value="" class="form-control" required>
                        </div>
