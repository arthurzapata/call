...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	...
	//
  $insertSQL = sprintf("INSERT INTO call_curso (cur_nombre, cur_descripcion, cur_activo,cur_remitente,cur_asunto) VALUES (%s, %s, %s, %s, %s)",
...
<div class="row">
                ...
                <div class="box box-primary">
                  ...
                  <h3 class="box-title"><i class="fa fa-briefcase"></i> Nuevo Curso</h3>
                  </div>
                  ...
                  <div class="box-body">
                    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                        ...
                        <div class="form-group">Curso:
                          <input type="text" name="cur_nombre" value="" class="form-control" required>
                        </div>
                        <div class="form-group">Remitente:
                          <input type="text" name="cur_remitente" value="" class="form-control" maxlength="100">
                        </div>
                        <div class="form-group">Asunto:
                          <input type="text" name="cur_asunto" value="" class="form-control" maxlength="100">
                        </div>
  ...
  ?>
    ...
    oEdit1.REPLACE("cur_descripcion");//Specify the id of the textarea here
                        ...
                        <div class="form-group">Activo:
                          <input type="checkbox" name="cur_activo" value="" checked>
                        </div>
