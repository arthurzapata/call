...
mysql_select_db($database_conexion, $conexion);
$query_mos_curso = "select * from cliente where cli_id = ".$colname_mos_curso."";
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE cliente SET nro_doc=%s,razon_social=%s, direccion=%s, telefono=%s, email=%s WHERE cli_id=%s",
...
<div class="row">
                  ...
                  <div class="box-body">
                    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                        ...
                        <div class="form-group">DNI / RUC:
                          <input type="text" name="nro_doc" value="<?php echo htmlentities($row_mos_curso['nro_doc'], ENT_COMPAT, 'UTF-8'); ?>" class="form-control" maxlength="12" required>
                        </div>
                        <div class="form-group">Nombres o Razon Social:
                          <input type="text" name="razon_social" value="<?php echo htmlentities($row_mos_curso['razon_social'], ENT_COMPAT, 'UTF-8'); ?>" class="form-control" maxlength="100" required>
                        </div>
                        <div class="form-group">Dirección:
                          <input type="text" name="direccion" value="<?php echo htmlentities($row_mos_curso['direccion'], ENT_COMPAT, 'UTF-8'); ?>" class="form-control" maxlength="100">
                        </div>
                        <div class="row">
                          <div class="col-md-6">
                           <div class="form-group">Teléfono:
                            <input type="text" name="telefono" value="<?php echo htmlentities($row_mos_curso['telefono'], ENT_COMPAT, 'UTF-8'); ?>" class="form-control"maxlength="12">
                          </div></div>
                          <div class="col-md-6">
                          <div class="form-group">Email:
                            <input type="email" name="email" value="<?php echo htmlentities($row_mos_curso['email'], ENT_COMPAT, 'UTF-8'); ?>" class="form-control">
                          </div></div>
                        </div>
              ...
              <a href="cliente.php" style="margin-left:10px;">
                 <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-times"></i> Cancelar</button></a>
                      ...
                      <input type="hidden" name="cli_id" value="<?php echo $row_mos_curso['cli_id']; ?>">
                    </form>
                  </div>                 
                  <!-- body -->
    </div><!-- /.primary-->
