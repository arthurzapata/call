...
mysql_select_db($database_conexion, $conexion);
$query_mos_curso = "SELECT p.fecha,u.usu_nombre,sum(total) as venta, monto, ((sum(total)/ monto) - 1) * 100 as crec from ppto p left join call_usuario u
on p.usu_id = u.usu_id left join documento d on p.usu_id = d.cc_vendedor and p.fecha = d.fecha_ped 
group by p.fecha,u.usu_nombre";
  ...
  <!--fecha,p.usu_id,u.usu_nombre,monto-->
    ...
    <?php do { ?>
      <tr>
        ...
        <td align="right"><?php echo $row_mos_curso['venta']; ?></td>
		    <td align="right"><?php echo $row_mos_curso['monto']; ?></td>
