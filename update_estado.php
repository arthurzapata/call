...
$query_mos_doc = "SELECT * FROM call_usuario where usu_id = $key";
...
$totalRows_mos_doc = mysql_num_rows($mos_doc);
	...
	if ($row_mos_doc['usu_activo'] == 0) 
		$es = 1;
	elseif($row_mos_doc['usu_activo'] == 1)
		$es = 0;
	
  $deleteSQL = sprintf("update call_usuario set usu_activo = $es where usu_id=%s",
