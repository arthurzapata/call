...
function writeFileSelections()
  ...
  Response.Write "<div style='overflow:auto;height:277px;width:100%;margin-top:3px;margin-bottom:2px;'>" & VbCrLf
...
function newFolder()
  {
    ...
    parent.modalDialogShow(currentPath + "/foldernew.asp", 250, 170, window);
  }
function deleteFolder()
  ...
  var currentPath = window.location.href;
  currentPath = currentPath.substring(0, currentPath.lastIndexOf("/"));
  parent.modalDialogShow(currentPath + "/folderdel.asp", 250, 170, window);
  }
