...
$colname_mos_config = "-1";
if (isset($_GET['id'])) {
  $colname_mos_config = $_GET['id'];
}
mysql_select_db($database_conexion, $conexion);
$query_mos_config = sprintf("SELECT * FROM call_config WHERE conf_id = %s", GetSQLValueString($colname_mos_config, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE call_config SET conf_url=%s, conf_correo=%s WHERE conf_id=%s",
                       GetSQLValueString($_POST['conf_url'], "text"),
                       GetSQLValueString($_POST['conf_correo'], "text"),
                       GetSQLValueString($_POST['conf_id'], "int"));
...
<div class="row">
                ...
                <div class="box box-primary">
                  ...
                  <h3 class="box-title"> <i class="fa fa-gears"></i> Editar Configuración</h3></div>
                   
                  <div class="box-body">
                    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                  
                        <div class="form-group">Url:
                          <input type="text" name="conf_url" value="<?php echo htmlentities($row_mos_config['conf_url'], ENT_COMPAT, 'UTF-8'); ?>" class="form-control">
                        </div>
                        <div class="form-group">Correo:
                          <input type="email" name="conf_correo" value="<?php echo htmlentities($row_mos_config['conf_correo'], ENT_COMPAT, 'UTF-8'); ?>" class="form-control">
                       </div>
              ...
              <a href="config.php" style="margin-left:10px;">
                 <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-times"></i> Cancelar</button></a>
                      
                     <input type="hidden" name="MM_update" value="form1">
                      <input type="hidden" name="conf_id" value="<?php echo $row_mos_config['conf_id']; ?>">
                    </form>
                  </div>
    </div><!-- /.primary-->
          </div><!-- /.col-->
