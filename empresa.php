...
mysql_select_db($database_conexion, $conexion);
$query_mos_user = "SELECT * FROM call_empresa";
...
{
mysql_select_db($database_conexion, $conexion);
$query_mos_user = "SELECT * FROM call_empresa where emp_nombre like '%".$_POST['buscar']."%'";
...
<div class="row">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-header"> <h3 class="box-title"><i class="fa fa-user"></i> Empresas</h3></div>
                   
                  <div class="box-body">
                  	<div class="row" style="margin-bottom:10px;">
                   		<div class="col-sm-6">
                        	<a class="btn btn-primary" href="empresa_new.php"><i class="fa fa-pencil"></i> Agregar</a>
						</div>
 ...
 // Show if recordset emptyxx ?>
  <table class="table table-bordered table-striped table-hover table-condensed tablesorter">
    ...
    <?php do { ?>
      <tr>
        <td><?php echo $row_mos_user['emp_id']; ?></td>
        <td><?php echo $row_mos_user['emp_nombre']; ?></td>
        <td><div align="center"><a href="empresa_edit.php?id=<?php echo $row_mos_user['emp_id']; ?>" title="Editar" class="hide-option"><button class="btn btn-primary btn-xs" type="button" data-toggle="tooltip" data-title="Editar"><i class="fa fa-edit"></i></button></a></div></td>
        <td>
          <div align="center"><a target="_blank" href="../registro.php?id=<?php echo $row_mos_user['emp_id']; ?>" title="Link" class="hide-option"><button class="btn btn-success btn-xs" type="button" data-toggle="tooltip" data-title="Link"><i class="fa fa-edit"></i></button></a></div>
        </td>
      </tr>
