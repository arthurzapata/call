...
mysql_select_db($database_conexion, $conexion);
  ...
  elseif ($perid==3) {
    ...
    $query_mos_subcat = "SELECT usu_id,usu_nombre,per_id FROM call_usuario where emp_id = ".$empid." and per_id in (2) and usu_activo = 1 and cor_id = ". $usuid." order by usu_nombre";
