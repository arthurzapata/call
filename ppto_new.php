...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $fecha_remitido = $_POST['fecha'];
  $fechaconver = implode('-',array_reverse(explode('-', $fecha_remitido)));
 
  $insertSQL = sprintf("INSERT INTO ppto (fecha,usu_id, monto) VALUES ( %s, %s, %s)",
                       GetSQLValueString($fechaconver, "text"),
...
<div class="row">
                ...
                <div class="box box-primary">
                  ...
                  <h3 class="box-title"><i class="fa fa-briefcase"></i> Nuevo PPTO</h3>
                  </div>
              ...
              <a href="ppto.php" style="margin-left:10px;">
