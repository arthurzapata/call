...
<div class="row">
                ...
                <div class="box box-primary">
                  ...
                  <h3 class="box-title"> <i class="fa fa-gears"></i> Configuración</h3></div>
        ...
        <div class="row">
        		...
        		<table class="table table-bordered table-striped table-hover table-condensed tablesorter">
                  ...
                  <?php do { ?>
                      <tr>
                        <td>
                        <a href="config_edit.php?id=<?php echo $row_mos_config['conf_id']; ?>">					
							<?php echo $row_mos_config['conf_url']; ?>
                        </a>
                        </td>
                        <td><?php echo $row_mos_config['conf_correo']; ?></td>
                        <td><div align="center"><a href="config_edit.php?id=<?php echo $row_mos_config['conf_id']; ?>" title="Editar" class="hide-option"><button class="btn btn-primary btn-xs" type="button" data-toggle="tooltip" data-title="Editar"><i class="fa fa-edit"></i></button></a></div></td>
                      </tr>
                      <?php } while ($row_mos_config = mysql_fetch_assoc($mos_config)); ?>
                  </table>
            	</div>
       </div>
