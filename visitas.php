...
if (isset($_POST['buscar'])) {
  	mysql_select_db($database_conexion, $conexion);
	$query_mos_curso = "SELECT * FROM call_visitas where cur_nombre like '%".$_POST['buscar']."%'";
...
<div class="row">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-header"> 
                  		<h3 class="box-title"><i class="fa fa-briefcase"></i> Visitas</h3></div>
                  <div class="box-body">
                  	<div class="row" style="margin-bottom:10px;">
                   		<div class="col-sm-6">
                        	<a class="btn btn-primary" href="visitas_new.php"><i class="fa fa-pencil"></i> Agregar</a>
						</div>
 ...
 // Show if recordset emptyxx ?>
  <table class="table table-bordered table-striped table-hover table-condensed tablesorter">
    ...
    <?php do { ?>
      ...
      <td><div align="center"><a href="visitas_edit.php?id=<?php echo $row_mos_curso['vis_id']; ?>" title="Editar" class="hide-option"><button class="btn btn-primary btn-xs" type="button" data-toggle="tooltip" data-title="Editar"><i class="fa fa-edit"></i></button></a></div></td>
        <td><div align="center"><a onclick="return confirm('¿Seguro que desea eliminar?')" href="visita_delete.php?id=<?php echo $row_mos_curso['vis_id']; ?>" title="Eliminar" class="hide-option"><button class="btn btn-primary btn-xs" type="button" data-toggle="tooltip" data-title="Eliminar"><i class="fa fa-trash-o"></i></button></a></div></td>
      </tr>
