...
{
mysql_select_db($database_conexion, $conexion);
$query_mos_user = "SELECT * FROM call_usuario u inner join call_perfil p on p.per_id = u.per_id inner join call_empresa e on u.emp_id = e.emp_id where usu_nombre like '%".$_POST['buscar']."%' and u.emp_id = ".$empid."";
...
<div class="row">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-header"> <h3 class="box-title"><i class="fa fa-user"></i> Usuarios</h3></div>
                   
                  <div class="box-body">
                  	<div class="row" style="margin-bottom:10px;">
                   		<div class="col-sm-6">
                        	<a class="btn btn-primary" href="usuario_new.php"><i class="fa fa-pencil"></i> Agregar</a>
						</div>
 ...
 // Show if recordset emptyxx ?>
  <table class="table table-bordered table-striped table-hover table-condensed tablesorter">
    ...
    <?php do { ?>
      <tr>
        <td><?php echo $row_mos_user['usu_id']; ?></td>
        <td><?php echo $row_mos_user['per_nombre']; ?></td>
        <td><?php echo $row_mos_user['usu_nombre']; ?></td>
        <td><?php echo $row_mos_user['emp_nombre']; ?></td>
        <td align="center"><?php if($row_mos_user['usu_activo']==1)
					 $estado = 'success'; else $estado= 'danger'; ?>
			<a href="update_estado.php?pk=<?php echo $row_mos_user['usu_id']; ?>" title="Cambiar Estado" class="hide-option">
            <button class="btn btn-<?php echo $estado?>" type="button" data-toggle="tooltip"></button></a>
		 </td>
      <td><div align="center"><a href="usuario_edit.php?id=<?php echo $row_mos_user['usu_id']; ?>" title="Editar" class="hide-option"><button class="btn btn-primary btn-xs" type="button" data-toggle="tooltip" data-title="Editar"><i class="fa fa-edit"></i></button></a></div></td>
        <td><div align="center"><a onclick="return confirm('¿Seguro que desea eliminar?')" href="usuario_delete.php?id=<?php echo $row_mos_user['usu_id']; ?>" title="Eliminar" class="hide-option"><button class="btn btn-primary btn-xs" type="button" data-toggle="tooltip" data-title="Eliminar"><i class="fa fa-trash-o"></i></button></a></div></td>
      </tr>
